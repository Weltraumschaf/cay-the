...
\lstdefinelanguage{CayThe}{
    ...
    keywordstyle=\textbf, 
    morekeywords={group, artifact, version, namespace, import, as, export, public, package, protected, private, class, interface, enum, annotation, use, this, constructor, new},
    sensitive=true,
