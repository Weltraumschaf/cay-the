...
Coordinates \textbf{must} not be duplicated in the imports.
...
A type is described by it's filename.
\todo{Describe how the file name thing work.}

Basically a type has a structure like:
