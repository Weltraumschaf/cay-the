...
\todo{Describe scope: It is not about interpretation vs. compilation, bytecode vs. machine code, JIT, VMs or such. Only the language and how it behaves.}

\chapter{TODO}\todo{Find new title.}
...
\todo{Composition is favoured over inheritance. Describe sophisticated delegation model built into a language.}
