...
public class CayTheSpecialSymbolTokenTest {
    ...
    public static Collection<TokenFixture[]> data() {
        TokenFixture[][] data = new TokenFixture[][] {
            ...
            {new TokenFixture(SourceHelper.createFrom("],"), "]", RIGHT_BRACKET)},
            {new TokenFixture(SourceHelper.createFrom("&"), "&", BW_AND)},
            {new TokenFixture(SourceHelper.createFrom("&foo"), "&", BW_AND)},
            {new TokenFixture(SourceHelper.createFrom("&&"), "&&", AND)},
            {new TokenFixture(SourceHelper.createFrom("&&foo"), "&&", AND)},
            {new TokenFixture(SourceHelper.createFrom("|"), "|", BW_OR)},
            {new TokenFixture(SourceHelper.createFrom("|foo"), "|", BW_OR)},
            {new TokenFixture(SourceHelper.createFrom("~"), "~", BW_NOT)},
            {new TokenFixture(SourceHelper.createFrom("~foo"), "~", BW_NOT)},
